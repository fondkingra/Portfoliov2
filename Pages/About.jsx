  ...
  return (
    <div
      className="h-screen w-screen
       bg-cover bg-center bg-repeat bg-gray-100 flex flex-col"
      style={{ 
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-2xl bg-white/10 backdrop-blur-md border border-white/20 rounded-lg shadow-lg p-8 text-center">
         <img src="\200.webp" alt="ash" className='w-32 h-32 rounded-full mx-auto mb-4 border-4 border-white/20'/>
          ...
          <p className="text-lg text-white/80">
            Feel free to reach out to me at <a href="mailto:dtrex460@gmail.com" className="text-blue-400 hover:underline">dtrex460@gmail.com</a> 
            or connect with me on <a href="https://www.linkedin.com/in/contact-ashwin-venkat/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">LinkedIn</a>.
          </p>
        </div>
      </div>
    </div>
